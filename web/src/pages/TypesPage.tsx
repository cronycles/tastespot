            ...
            {sortedTypes.length > 0 ? (
                <div className={`list${dragging ? " is-dragging" : ""}`} ref={listRef}>
                    {sortedTypes.map((type, index) => {
                        ...
                        const isTarget = dragging !== null && dragging.to === index && dragging.from !== index;
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="types-row-actions">
                                    <button type="button" className="types-icon-button" onClick={() => navigate(`/private/types/${type.id}/edit`)} aria-label="Modifica tipologia">
                                        <IoPencilOutline />
                                    </button>
