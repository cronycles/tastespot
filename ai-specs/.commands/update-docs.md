...
2. Update the relevant files in `docs/` (for example):
    - `docs/specific-api-model.yml` for API contract changes
    - `docs/specific-data-model.md` for schema/model changes
    - `docs/specific-tech-backend-doc.mdc` or `docs/specific-tech-frontend-doc.mdc` for architecture/process conventions
    - `docs/business-doc.mdc` for UX flow changes
