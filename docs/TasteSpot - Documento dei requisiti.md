...
Creare un'app per dispositivi Android e iOS che consenta agli utenti di valutare le attività di ristorazione (caffè, drink bar, gelaterie, ristoranti, panifici, enoteche, pasticcerie, pizzerie, ecc.), fornendo, se vogliono, valutazioni specifiche delle diverse categorie di voto.
...
- Se l'app non riesce a geolocalizzare l'utente → mappa su **Genova** di default
