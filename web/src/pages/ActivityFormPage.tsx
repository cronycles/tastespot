...
export function ActivityFormPage({ mode, activity }: Props) {
  ...
  function toggleType(typeId: string): void {
    setForm((current) => ({
      ...current,
      selectedTypeIds: current.selectedTypeIds.includes(typeId)
        ? current.selectedTypeIds.filter((entry) => entry !== typeId)
        : [...current.selectedTypeIds, typeId],
    }))
  }
    ...
    <section className="page-card">
      <div className="types-toolbar">
        <div className="stack">
          ...
          <p className="muted">Form web per creazione e modifica attivita'.</p>
        </div>
      ...
      <form className="activity-form" onSubmit={(event) => void handleSubmit(event)}>
        ...
        <div className="field">
          ...
          <textarea
            ...
            placeholder="Appunti o dettagli utili"
          />
        </div>
        ...
        <div className="stack">
          ...
          <div className="activity-tags-input-row">
            <input
              ...
              onChange={(event) => updateField('tagsInput', event.target.value.toLowerCase())}
              placeholder="es. economico romantico"
            />
