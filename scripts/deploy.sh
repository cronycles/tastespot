...
COMPOSER=/home/crointhe/bin/composer
...
rm -f "$COMPOSER"
mkdir -p /home/crointhe/bin
curl -sS https://getcomposer.org/installer | $PHP -d allow_url_fopen=On -- --install-dir=/home/crointhe/bin --filename=composer
